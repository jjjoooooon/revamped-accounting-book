...
const TAB_ITEMS = [
  {
    ...
    icon: Building2,
    description: "Mosque details and branding",
  },
  {
    value: "finance",
    label: "Financial Config",
    icon: Wallet,
    description: "Billing cycles and currency",
  },
  {
    value: "notifications",
    label: "Notifications",
  ...
  },
  {
    ...
    icon: PanelBottom,
    description: "App-wide footer content",
    role: "superadmin",
  },
  {
    value: "system-status",
  ...
  },
  {
    ...
    label: "Admin Alerts",
    icon: Inbox,
    description: "Contact & Reset requests",
    role: "superadmin",
  },
  {
    value: "backup",
...
export default function SettingsPage() {
  ...
  const {
    ...
    mutate,
  } = useSWR("/api/settings/app", fetcher);
  const { data: systemStatus, isLoading: isLoadingSystem } = useSWR(
    activeTab === "system-status" ? "/api/system/status" : null,
    fetcher,
    { refreshInterval: 30000 },
  );
  const { data: adminAlerts, mutate: mutateAlerts } = useSWR(
    activeTab === "admin-alerts" ? "/api/admin/notifications" : null,
    fetcher,
    { refreshInterval: 60000 },
  );
  const { data: resetRequests, mutate: mutateResets } = useSWR(
    activeTab === "admin-alerts" ? "/api/admin/reset-requests" : null,
    fetcher,
    { refreshInterval: 60000 },
  );
  ...
  const handleFooterToggle = () => {
    setFooterSettings({
      ...footerSettings,
      showFooter: !footerSettings?.showFooter,
    });
  };
  ...
  const handleFactoryReset = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          "Factory reset completed. Data will be held for 7 days before permanent deletion.",
        );
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-500 text-sm max-w-2xl">
            Manage your organization settings, team members, and system
            ...
            <div className="sticky top-6">
              ...
              <div className="mt-8 px-4 py-4 rounded-xl bg-gradient-to-br from-emerald-900 to-emerald-800 text-white shadow-lg shadow-emerald-900/10">
                ...
                <Button
                  size="sm"
                  variant="secondary"
                  className="w-full text-xs h-8 bg-white/10 hover:bg-white/20 text-white border-0"
                >
                  Contact Support
                </Button>
              </div>
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Official details used for receipts and reports.
                      </p>
                    </div>
                    <Button
                      onClick={handleSave}
                      ...
                      <div className="flex flex-col md:flex-row gap-8 items-start">
                        <div className="flex-shrink-0 group relative">
                          ...
                          <div className="absolute -bottom-2 -right-2">
                            <Button
                              size="icon"
                              className="h-8 w-8 rounded-full shadow-md bg-white text-slate-700 hover:bg-slate-50 border border-slate-200"
                              onClick={() => fileInputRef.current?.click()}
                            >
                ...
                <TabsContent value="finance" className="mt-0 space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Manage billing cycles and receipt defaults.
                      </p>
                    </div>
                    <Button
                      onClick={handleSave}
                  ...
                  <div className="grid gap-6">
                      ...
                      <CardContent className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              handleSelectChange("fiscalYearStart", v)
                            }
                          >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <Input
                              ...
                              className="h-10 pl-9 bg-slate-50"
                            />
                    ...
                    <Card className="border-slate-200 shadow-sm">
                      <CardHeader className="pb-4">
                        ...
                        <CardDescription>
                          Configure how Sanda bills are generated.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg border border-slate-100">
                          <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-slate-500">
                              Automatically create invoices for active members
                              monthly.
                            </p>
                          </div>
                          <Switch
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Select
                              defaultValue={settings.autoBillDate}
                              onValueChange={(v) =>
                                handleSelectChange("autoBillDate", v)
                              }
                            >
                              <SelectTrigger className="h-10 w-full">
                                <SelectValue />
                      ...
                      <div className="flex items-center justify-between p-6 hover:bg-slate-50/50 transition-colors">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500">
                              Send digital receipts via email automatically.
                            </p>
                          </div>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between p-6 hover:bg-slate-50/50 transition-colors">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500">
                              Send payment reminders via WhatsApp integration.
                            </p>
                          </div>
                        </div>
                        <Switch
                    ...
                    <CardContent className="p-0">
                      <div className="divide-y divide-slate-100">
                        {teamMembers.map((member) => (
                          <div
                            key={member.id}
                            className="flex items-center justify-between p-4 sm:p-6 hover:bg-slate-50/50 transition-colors group"
                          >
                              ...
                              <div>
                                <p className="text-sm font-medium text-slate-900 flex items-center gap-2">
                                  ...
                                  {member.id === 1 && (
                                    <Badge
                                      variant="secondary"
                                      className="text-[10px] px-1 py-0 h-5 bg-emerald-100 text-emerald-700"
                                    >
                                      You
                                    </Badge>
                                  )}
                  ...
                  <TabsContent value="admin-alerts" className="mt-0 space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                      <div>
                        ...
                        <p className="text-sm text-slate-500">
                          Manage reset requests and user messages.
                        </p>
                      </div>
                      <Button
                        variant="outline"
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        {adminAlerts?.notifications?.filter(
                          (n) => n.type === "CONTACT_FORM",
                        ).length === 0 ? (
                                ...
                                <CardContent className="p-4 space-y-3">
                                  ...
                                  <div className="flex items-center justify-between text-xs">
                                    <span className="text-slate-500">
                                      From: {notif.data?.userName} (
                                      {notif.data?.userEmail})
                                    </span>
                                    <a
                                      href={`mailto:${notif.data?.contactEmail}`}
                ...
                <TabsContent value="backup" className="mt-0 space-y-6">
                  <div className="pb-4 border-b border-rose-100">
                    ...
                    <p className="text-sm text-rose-600/80">
                      Advanced actions that affect data integrity.
                    </p>
                  </div>
                    ...
                    <Card className="border-slate-200 shadow-sm">
                      <CardContent className="p-6 flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            Download a full JSON backup of all mosque data.
                          </p>
                        </div>
                        <Button
                          variant="outline"
                      ...
                      <CardContent className="p-6 space-y-4">
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-rose-600">
                            This will mark all members, payments, expenses, and
                            other data for deletion. An admin can restore your
                            data within 7 days. After that, data is permanently
                            deleted.
                          </p>
                        </div>
                        ...
                        {!showResetConfirm ? (
                          ...
                          <div className="space-y-4 p-4 bg-rose-100 rounded-lg border border-rose-200">
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-rose-700">
                                  This action cannot be easily undone. Please
                                  type{" "}
                                  <strong>
                                    {settings.mosqueName || "DELETE ALL DATA"}
                                  </strong>{" "}
                                  to confirm.
                                </p>
                              </div>
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                setResetConfirmPhrase(e.target.value)
                              }
                    ...
                    <Card className="border-slate-200 shadow-sm">
                      <CardContent className="p-6 space-y-4">
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            Need help or want to restore deleted data? Send a
                  ...
                  <TabsContent value="footer" className="mt-0 space-y-6">
                    <div className="flex items-center justify-between pb-4 border-b border-slate-200">
                      <div>
                        ...
                        <p className="text-sm text-slate-500">
                          Customize the application footer.
                        </p>
                      </div>
                      <Button
                        onClick={handleSaveFooter}
                        disabled={isSaving || isLoadingFooter}
                        className="bg-emerald-600 hover:bg-emerald-700"
                      >
                        {isSaving ? (
                          <Loader2 className="w-4 h-4 animate-spin mr-2" />
                          ...
                          <>
                            <div className="grid md:grid-cols-2 gap-6">
                              <div className="space-y-2">
                                ...
                                <Input
                                  id="appName"
                                  value={footerSettings?.appName || ""}
                                  onChange={handleFooterChange}
                                  placeholder="Masjid System"
                                  className="h-10"
                                />
                              </div>
                              <div className="space-y-2">
                                ...
                                <Input
                                  id="appVersion"
                                  value={footerSettings?.appVersion || ""}
                                  onChange={handleFooterChange}
                                  placeholder="1.0.0"
                                  className="h-10"
                                />
                            ...
                            <div className="flex items-center justify-between">
                              <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-slate-500">
                                  Show footer across the application
                                </p>
                              </div>
                              <Switch
                                checked={footerSettings?.showFooter || false}
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                              ...
                              <span className="text-sm font-mono font-medium">
                                {systemStatus?.database?.latency || "N/A"}
                              </span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                              <span className="text-sm text-slate-600">
                              ...
                              <span className="text-sm font-mono font-medium">
                                {systemStatus?.database?.size || "Unknown"}
                              </span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                              <span className="text-sm text-slate-600">
                              ...
                              <span className="text-sm font-medium">
                                {systemStatus?.database?.provider ||
                                  "PostgreSQL"}
                              </span>
                            </div>
                          </CardContent>
                        ...
                        <Card className="border-slate-200 shadow-sm">
                          ...
                          <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                              ...
                              <span className="text-sm font-mono font-medium">
                                v{systemStatus?.system?.version || "1.0.0"}
                              </span>
                            </div>
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                              <span className="text-sm text-slate-600">
